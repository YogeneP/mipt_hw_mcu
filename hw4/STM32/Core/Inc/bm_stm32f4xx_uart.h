/*
Leightweight single UART non-blocking implementation for STM32F4xx family 
DO NOT enable the USART instance in Cube MX, no HAL features used
NO NVIC IRQ HANDLER NEEDED
Port configuration:
- word length 8 bit
- no parity check
- 1 stop bit
...
#define BM_UART_N 2 // e.g. 1 means USART1 as CMSIS reference  
#define BM_UART_BUS APB1 // Refer to to MCU datasheet "USART feature comparison"
...
#define BM_UART_TX_PIN_N 2 // Refer to to MCU datasheet "Pin definitions"
#define BM_UART_RX_PIN_N 3 // Refer to to MCU datasheet "Pin definitions"
#define BM_UART_PINS_AF 7U // Refer to MCU datasheet "Alternate function mapping"
#define BM_UART_BUS_CLOCK 16000000ULL // Refer to RCC setup
#define BM_UART_NVIC_PRIORITY 10 // 0...15, less number - higher priority
...
extern volatile int32_t BM_UART_rx_res;
